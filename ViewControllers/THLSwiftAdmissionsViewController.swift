...
class THLSwiftAdmissionsViewController: UIViewController, THLEventPickerViewControllerDelegate, UICollectionViewDelegate, UICollectionViewDataSource, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate, TTTAttributedLabelDelegate {
    ...
    override func loadView() {
        ...
        buttonBackground.backgroundColor = UIColor.blackColor()
        ...
        self.contactConciergeLabel.textColor = UIColor.whiteColor()
        self.contactConciergeLabel.font = UIFont(name: "Raleway-Regular", size: 14)
        self.contactConciergeLabel.numberOfLines = 0
        self.contactConciergeLabel.linkAttributes = [NSForegroundColorAttributeName: UIColor.whiteColor(), NSUnderlineColorAttributeName: UIColor.customGoldColor(), NSUnderlineStyleAttributeName: NSUnderlineStyle.StyleThick.rawValue]
        self.contactConciergeLabel.activeLinkAttributes = [NSForegroundColorAttributeName: UIColor.whiteColor(), NSUnderlineStyleAttributeName: NSUnderlineStyle.StyleNone.rawValue]
        ...
        let concierge: NSRange = labelText.rangeOfString("concierge")
        contactConciergeLabel.addLinkToURL(NSURL(string: "action://show-intercom")!, withRange: concierge)
    ...
    override func viewDidLayoutSubviews() {
        ...
        admissionOptionCollectionView.frame = CGRectMake(0, 0 + eventPickerView.view.frame.size.height, self.view.frame.size.width, self.view.frame.size.height - eventPickerView.view.frame.size.height - 80.0)
        buttonBackground.frame = CGRectMake(0, eventPickerView.view.frame.size.height + admissionOptionCollectionView.frame.size.height, view.frame.size.width, 80.0)
        separatorView.frame = CGRectMake(0, 0, view.frame.size.width, 0.5)

        contactConciergeLabel.center = buttonBackground .convertPoint(buttonBackground.center, fromView: buttonBackground.superview)
    }
