...
CGFloat X_BUFFER = 10.0; //%%% the number of pixels on either side of the segment
...
-(void)setupSegmentButtons {
    ...
    for (int i = 0; i<numControllers; i++) {
        ...
        button.titleLabel.font = [UIFont fontWithName:@"Raleway-Medium" size:16.0f];
        button.tag = i; //%%% IMPORTANT: if you make your own custom buttons, you have to tag them appropriately
        button.backgroundColor = kTHLNUIPrimaryBackgroundColor;//%%% buttoncolors
...
-(void)setupSelector {
    ...
    selectionBar.backgroundColor = kTHLNUIAccentColor; //%%% sbcolor
