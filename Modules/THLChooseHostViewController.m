...
#import "THLChooseHostViewModel.h"

@interface THLChooseHostViewController()
...
@implementation THLChooseHostViewController
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view {
	...
	THLChooseHostViewModel *model = self.viewModels[index];
