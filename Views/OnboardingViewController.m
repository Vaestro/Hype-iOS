...
- (void)setSubtitleTextColor:(UIColor *)subtitleTextColor {
    for (OnboardingContentViewController *contentVC in self.viewControllers) {
        contentVC.subtitleTextColor = subtitleTextColor;
    }
}
...
- (void)setFontName:(NSString *)fontName {
    for (OnboardingContentViewController *contentVC in self.viewControllers) {
        ...
        contentVC.subtitleFontName = fontName;
...
- (void)setSubtitleFontName:(NSString *)fontName {
    for (OnboardingContentViewController *contentVC in self.viewControllers) {
        contentVC.subtitleFontName = fontName;
    }
}
...
- (void)setUnderSubtitlePadding:(CGFloat)underSubtitlePadding {
    for (OnboardingContentViewController *contentVC in self.viewControllers) {
        contentVC.underSubtitlePadding = underSubtitlePadding;
    }
}
